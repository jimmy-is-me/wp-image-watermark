...
class WPIWM_Media_Handler {
    ...
    private function __construct() {
         ...
         *
         * add_attachment fires before WordPress finishes writing sub-sizes.
         * wp_generate_attachment_metadata fires after ALL thumbnails are done.
         * The original file is stable at this point and will not be re-written.
         *
         * Priority 999 so we run after other plugins (e.g. image optimizers).
         */
    ...
    public function on_generate_metadata( $metadata, $attachment_id ) {
        ...
        // Prevent duplicate watermarking (e.g. when thumbnails are regenerated by other plugins)
        if ( get_post_meta( $attachment_id, '_wpiwm_watermarked', true ) ) {
            error_log( 'WPIWM auto: skipped – already watermarked (attachment ' . $attachment_id . ')' );
            return $metadata;
        }
